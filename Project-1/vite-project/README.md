...
> ⚠️ কোনো তৃতীয় পক্ষের লাইব্রেরি ব্যবহার করা হয়নি। সমস্ত ফিচার কেবল React এবং TailwindCSS দিয়ে ইমপ্লিমেন্ট করা হয়েছে।
...
- প্রতিটি কার্ডে থাকবে:
  ...
  - Icon: Domain এর প্রথম দুটি অক্ষর এবং সিলেক্ট করা কালার অনুযায়ী
...
- কোনো Third-Party লাইব্রেরি ব্যবহার করা হয়নি।
